/**
 * @file CornerDetectorModuleMain.cpp
 * @brief ...
 *
 ...
 * have this file and the CornerDetectorModule header and code in a separate "aim" directory.
 */
int main(int argc, char *argv[])  {
	CornerDetectorModuleExt *m = new CornerDetectorModuleExt();
