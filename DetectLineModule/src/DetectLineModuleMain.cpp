 ...
 * have this file and the DetectLineModule header and code in a separate "aim" directory.
 */
int main(int argc, char *argv[])  {
	DetectLineModuleExt *m = new DetectLineModuleExt();
