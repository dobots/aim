 ...
 * have this file and the FindRobotModule header and code in a separate "aim" directory.
 */
int main(int argc, char *argv[])  {
	FindRobotModuleExt *m = new FindRobotModuleExt();
