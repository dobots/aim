/**
 * @file MovingAverageModuleMain.cpp
 * @brief ...
 *
 ...
 * have this file and the MovingAverageModule header and code in a separate "aim" directory.
 */
int main(int argc, char *argv[])  {
	MovingAverageModuleExt *m = new MovingAverageModuleExt();
